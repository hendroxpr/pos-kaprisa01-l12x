...
class StokkeluarmasukController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $remark = 'Halaman ini digunakan untuk menampilkan <b>Stok Keluar-Masuk</b>.';
        $page = 'pos01::laporan.stokkeluarmasuk';
        $link = '/pos01/laporan/stokkeluarmasuk';
        $subtitle = 'Laporan';
        $caption = 'Stok Keluar-Masuk';
        $jmlhal = 2;
