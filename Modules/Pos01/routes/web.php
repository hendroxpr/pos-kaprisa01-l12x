...
Route::get('/laporan/hutangpiutangshowhutangpiutangsajacustomer', [HutangpiutangController::class, 'showhutangpiutangsajacustomer'])->name('pos01.laporan.hutangpiutang_showhutangpiutangsajacustomer')->middleware('auth'); /* menampilkan data hutangpiutangsajacustomer pada datatable javascript */
Route::get('/laporan/hutangpiutangshowhutangpiutangsajasupplier', [HutangpiutangController::class, 'showhutangpiutangsajasupplier'])->name('pos01.laporan.hutangpiutang_showhutangpiutangsajasupplier')->middleware('auth'); /* menampilkan data hutangpiutangsajasupplier pada datatable javascript */
