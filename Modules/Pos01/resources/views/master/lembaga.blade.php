                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <input name="lembaga1" id="lembaga1" class="w3-input w3-border" maxlength="50" type="search" placeholder="Lembaga" value="{{ old('lembaga1') }}" required>
                                </div>								  
                            </div>
                            <div class="row">
                                <div class="col-md-4 mt-1" align="right">									
                                    <h6 class="mt-2">Grup *)</h6>
                                </div>
                                <div class="col-md-8">                                
                                    <input name="grup1" id="grup1" class="w3-input w3-border" maxlength="50" type="search" placeholder="Grup" value="{{ old('grup1') }}" required>
                                </div>								  
                            </div>
                            <div class="row">
                                <div class="col-md-4 mt-1" align="right">									
...
$(document).ready(function(){
    ...
    setTimeout(() => {
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pos01.master.lembaga_show')}}`,
            columns: [
    ...
    function data_simpan(){
        ...
        let formData = new FormData();
            ...
            formData.append('lembaga1', lembaga1);
            formData.append('grup1', grup1);
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('pos01.master.lembaga_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('pos01/master/lembagaedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
		        ...
		        success : function(data){
                    ...
                    for(i=0; i<resultData.length; i++){
                        ...
                        $('#lembaga1').val(resultData[i].lembaga);
                        $('#grup1').val(resultData[i].grup);
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('pos01/master/lembagadestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
