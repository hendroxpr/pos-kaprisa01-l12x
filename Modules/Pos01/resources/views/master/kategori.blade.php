                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <input name="kategori1" id="kategori1" class="w3-input w3-border" maxlength="50" type="search" placeholder="Kategori" value="{{ old('kategori1') }}" required>
                                </div>								  
                            </div>
                            <div class="row">
                                <div class="col-md-4 mt-1" align="right">									
                                ...
                                <div class="col-md-8">                                
                                    ...
                                    <textarea name="keterangan1" id="keterangan1" rows="10" style="width: 100%; padding-left:10px; padding-right:10px;" class="w3-textarea w3-border"></textarea>
...
$(document).ready(function(){
    ...
    setTimeout(() => {
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pos01.master.kategori_show')}}`,
            columns: [
    ...
    function data_simpan(){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('pos01.master.kategori_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('pos01/master/kategoriedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
		        ...
		        success : function(data){
                    ...
                    for(i=0; i<resultData.length; i++){
                        ...
                        $('#kategori1').val(resultData[i].kategori);
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('pos01/master/kategoridestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
