                    ...
                    <form class="form-horizontal" id="formSimpan" nama="formSimpan" action="" method="">
                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <input name="satuan1" id="satuan1" class="w3-input w3-border" maxlength="15" type="search" placeholder="Satuan" value="{{ old('satuan1') }}" required>
                                </div>								  
                            </div>
                            <div class="row">
                                <div class="col-md-4 mt-1" align="right">									
...
$(document).ready(function(){
    ...
    setTimeout(() => {
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pos01.master.satuan_show')}}`,
            columns: [
    ...
    function data_simpan(){
        ...
        let formData = new FormData();
            ...
            formData.append('satuan1', satuan1);
            formData.append('keterangan1', keterangan1);
          
        $.ajax({
            enctype: 'multipart/form-data',
            type   : 'post',
            url    : '{{route('pos01.master.satuan_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('pos01/master/satuanedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
		        ...
		        success : function(data){
                    ...
                    for(i=0; i<resultData.length; i++){
                        ...
                        $('#satuan1').val(resultData[i].satuan);
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('pos01/master/satuandestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
