                        ...
                        <div class="modal-body" id="bodyAdd" name="bodyAdd">                        
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8"> 
                                    ...
                                    <input name="barcode1" id="barcode1" class="w3-input w3-border" maxlength="15" type="search" placeholder="Barcode" value="{{ old('barcode1') }}" required>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">                                
                                    <input name="keterangan1" id="keterangan1" class="w3-input w3-border" maxlength="100" type="search" placeholder="Keterangan" value="{{ old('keterangan1') }}" >
                                </div>								  
                            </div>
...
$(document).ready(function(){
    ...
    function tampil_listbarang(){				
     ...
     function tampil_data1(){
        ...
        return $('#data1').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pos01.master.barcode_show')}}`,
            columns: [
    ...
    caribarangDatatable = tampil_data_caribarang();    
     function tampil_data_caribarang(){
        ...
        return $('#caribarang').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax   : `{{route('pos01.master.barang_showbarang')}}`,
            columns: [
                // { data: 'no', name:'id', render: function (data, type, row, meta) {
                //     return meta.row + meta.settings._iDisplayStart + 1;
                // }},
    ...
    function data_simpan(){
        ...
        $.ajax({
            ...
            type   : 'post',
            url    : '{{route('pos01.master.barcode_create')}}',
            data: formData,
            cache: false,
            processData: false,
            contentType: false,
    ...
    function data_edit(idx){
        var id1=idx;			
            $.ajax({
		        type  : 'get',
		        url   : `{{ url('pos01/master/barcodeedit')}}/${id1}`,
		        async : false,
		        dataType : 'json',	
    ...
    function data_hapus(){			
        ...
        $.ajax({
            type  : 'get',
            url   : '{{url('pos01/master/barcodedestroy')}}/'+id3,
            async : false,
            dataType : 'json',					
            success : function(data){
                tampil_dataTable();
