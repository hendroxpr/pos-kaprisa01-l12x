            ...
            <div class="col-md-6">
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-7 input-group">
                        ...
                        <select  name="idbarangx1" id="idbarangx1" class="" style="border-radius:0px; border:none; display:none;"></select>
...
<script type="text/javascript">
    ...
    var listbarangDatatable;
    var caribarangDatatable;
$(document).ready(function(){
    ...
    $('#idruang1').on('change',function(){
        ...
        setTimeout(() => {
            kirimsyarat();            	
            setTimeout(() => {
                listbarangDatatable = tampil_listbarang(); 
                caribarangDatatable = tampil_caribarang();                  
                setTimeout(() => {
                    listbarangDatatable.ajax.url('{{route('pos01.laporan.kartustok_listbarang')}}').load();                
                    listbarangDatatable.draw(null, false);                                                    
                    caribarangDatatable.ajax.url('{{route('pos01.laporan.kartustok_showbarang')}}').load();                
...
function tampil_caribarang(){
    ...
    function ambilcari(t){
        ...
        var x = $('#idbarang1 option:selected').text();
        var y = x.trim();
